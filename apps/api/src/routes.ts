...
router.post('/tickets/:id/suggest', async (req, res) => {
  const { id } = req.params;
...
router.post('/tickets/:id/apply', async (req, res) => {
  const { id } = req.params;
...
router.post('/patch-plans', async (req, res) => {
...
router.post('/patch-runs', async (req, res) => {
...
router.post('/patch-runs/:id/rollback', async (req, res) => {
  const { id } = req.params;
...
router.post('/insights/recompute', async (_req, res) => {
  // Simulate recompute
  res.json({ ok: true });
});

// Agents (CoreNin orchestration)
router.post('/agents/triage-alerts', async (_req, res) => {
...
router.post('/agents/daily-maintenance', async (_req, res) => {
