      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="py-20 text-center">
          ...
          <p className="text-xl text-primary-100 mb-8 max-w-2xl mx-auto">
            Automatically detect system issues, create actionable tickets, and execute fixes — 
            so your team focuses on judgment, not routine firefighting.
          </p>
          <div className="space-x-4">
            <Link
              href="/register"
        ...
        <div className="grid md:grid-cols-3 gap-8 py-16">
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">Smart Alert Detection</h3>
            <p className="text-primary-100">
              Automatically prioritize alerts from multiple monitoring systems and eliminate alert fatigue.
            </p>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
            <Zap className="text-white mb-4" size={40} />
            <h3 className="text-xl font-semibold text-white mb-2">Autonomous Actions</h3>
            <p className="text-primary-100">
              AI agents execute diagnostics, patches, and fixes with human oversight and approval.
            </p>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
            ...
            <p className="text-primary-100">
              Track automation ROI, resolution times, and system health metrics.
            </p>
          </div>
        </div>
      </div>
